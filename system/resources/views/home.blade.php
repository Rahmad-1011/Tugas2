									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="{{ url('/product') }}">Laptop MSI</a></h3>
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h4 class="product-price">Rp.8.000.000</h4>
												<div class="product-rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Penawaran menarik minggu ini</h2>
							<p>diskon sampai 50%</p>
							<a class="primary-btn cta-btn" href="#">Beli sekarang</a>
						</div>
					</div>
				</div>
				<!-- /row -->
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Penjualan Teatas</h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Laptop</a></li>
									<li><a data-toggle="tab" href="#tab2">Smartphone</a></li>
									<li><a data-toggle="tab" href="#tab2">Kamera</a></li>
									<li><a data-toggle="tab" href="#tab2">Aksesoris</a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											...
											<div class="product-body">
												<p class="product-category">Smartphone</p>
												<h3 class="product-name"><a href="#">SAMSUNG J2 Prime</a></h3>
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h4 class="product-price">Rp.10.500.000 <del class="product-old-price">Rp.15.000.000</del></h4>
												<div class="product-rating">
												</div>
												<div class="product-btns">
													<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">Keinginan</span></button>
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="#">Nikon</a></h3>
												<h4 class="product-price">Rp.2.000.000</h4>
												<div class="product-rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
